...
const AmbulanceSignUp = () => {
  ...
  const signupHandle = (event) => {
    ...
    // Replace the following code with your actual signup logic
    console.log("Signing up with:", name, email, phoneNo, cnic, password);
        ...
        <div className="signup-form custom-scrollbar">
          ...
          <form onSubmit={signupHandle}>
            ...
            <p className="note">
              ...
              <span>click Login button to proceed to the Dashboard.</span>
            </p>
          </form>
        </div>
      </div>
